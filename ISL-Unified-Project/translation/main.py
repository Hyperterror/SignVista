...
3. Skin Segmentation
'''
yolo = YOLO("../config/yolo/cross-hands.cfg", "../config/yolo/cross-hands.weights", ["hand"])
yolo.confidence = 0.5
...
'''
model = keras.models.load_model("../models/translation/squeezenet_model")
...
for f in files:
    ...
    if filename.split('_')[0] == clip_timestamp:
        ...
        opcount[predictImage(input_file_location, '../config/translation_classes.json', 1)[0][0]] += 1
